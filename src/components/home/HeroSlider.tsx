...
import BackgroundOne from "../../assets/images/Real Estate and Agriculture Mix.png";
import BackgroundTwo from "../../assets/images/real ima.png";
import BackgroundThree from "../../assets/images/slide3.png";
import "swiper/css";
...
const HeroSlider = () => {
  ...
  return (
    <section className="relative font-Outfit h-[870px] w-full">
      <Swiper
