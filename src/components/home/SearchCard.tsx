  ...
  return (
    <div className="mx-auto w-full rounded-[1.5rem] border border-white/30 bg-white/60 p-4 shadow-xl backdrop-blur-lg sm:p-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <Link
          to="/properties"
          className="flex w-full items-center justify-center gap-2 rounded-full bg-[#002B66] px-5 py-3 text-sm font-medium text-white sm:w-auto sm:min-w-[148px] sm:text-base"
        >
          <IoHomeOutline />
          Property
        </Link>

        <button className="flex w-full items-center justify-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-medium text-gray-700 sm:w-auto sm:min-w-[148px] sm:text-base">
          <GiFarmTractor />
          Agri-Projects
        </button>
