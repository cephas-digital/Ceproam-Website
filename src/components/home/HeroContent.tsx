...
const HeroContent = ({
  ...
  return (
    ...
    //   <div className="relative z-10 flex md:min-h-screen h-auto sm:h-auto md:h-[600px] w-full flex-col items-center justify-start px-4 pt-16 pb-40 text-center sm:px-6 sm:pt-20 sm:pb-48 md:justify-center md:py-4 md:pt-0 md:pb-24 lg:justify-center lg:py-4 lg:pt-0">
    //     <motion.div
    ...
    //     <div className="mt-6 w-full max-w-md px-0 sm:mt-8 sm:max-w-2xl md:max-w-2xl md:mt-10 lg:absolute lg:bottom-[-36px] lg:left-1/2 lg:mt-0 lg:w-[calc(100%-2rem)] lg:-translate-x-1/2 lg:px-4 lg:max-w-none mx-auto">
    //       <SearchCard />
    //     </div>
    //   </div>
    // </section>
